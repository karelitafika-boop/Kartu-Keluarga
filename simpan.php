...
if(mysqli_num_rows($cek) > 0){
    echo "<script>alert('Kamu sudah membuat KK'); window.location='tampil_kk.php';</script>";
    exit;
}
...
echo "<script>alert('Data KK berhasil diajukan'); window.location='tampil_kk.php';</script>";
exit;
?>
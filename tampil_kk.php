...
<div class="container">
    <div class="glass-card">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <?php if ($role == "admin") { ?>
            <a href="login_users.php" class="btn btn-secondary">← Kembali</a>
            <?php } else { ?>
            <a href="dashboard.php" class="btn btn-secondary">← Kembali</a>
            <?php } ?>
            <?php if ($role != "admin") { ?>
            <a href="login_db.php" class="btn btn-dark" title="Admin">
        ...
        <?php if ($role == "user") { ?>
        <div class="alert">Kamu belum membuat KK.<br><br>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <?php if ($d['status'] == 'disetujui') { ?>
                                <a href="landing.php?id=<?= $d['id_kk']; ?>" class="btn btn-info btn-sm mb-1">Detail / Cetak</a>
                            <?php } else { ?>
                                <button class="btn btn-secondary btn-sm mb-1" disabled>Belum Bisa Cetak</button>
                            <?php } ?>

                            <?php if ($role == "admin") { ?>
                                <br>
                                <a href="edit_kk.php?id=<?= $d['id_kk']; ?>" class="btn btn-warning btn-sm mb-1">Edit</a>
                                <a href="hapus_kk.php?id=<?= $d['id_kk']; ?>" class="btn btn-danger btn-sm mb-1" 
                                    onclick="return confirm('Yakin ingin hapus data ini?')">Hapus
                                </a>

                            <?php if ($d['status'] != 'disetujui') { ?>
                                <a href="verifikasi_kk.php?id=<?= $d['id_kk']; ?>" class="btn btn-success btn-sm mb-1">Verifikasi</a>
                            <?php } else { ?>
                                <button class="btn btn-success btn-sm mb-1" disabled>Sudah Disetujui</button>
                            <?php } ?>
